        ...
        <div className="mb-16 pb-16 border-b border-background/20">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                type="submit"
                className="px-6 py-3 rounded-lg bg-primary hover:bg-primary/90 text-primary-foreground font-semibold transition"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com/avanmakerspace" target="_blank" rel="noopener noreferrer" className="text-background/70 hover:text-background transition" aria-label="Facebook">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a href="https://twitter.com/avanmakerspace" target="_blank" rel="noopener noreferrer" className="text-background/70 hover:text-background transition" aria-label="Twitter">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://instagram.com/avanmakerspace" target="_blank" rel="noopener noreferrer" className="text-background/70 hover:text-background transition" aria-label="Instagram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/get-involved" className="text-background/70 hover:text-background transition">
                  Donate
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-background/20 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center text-background/70 text-sm">
            ...
            <div className="flex space-x-6 mt-4 sm:mt-0">
              <Link href="/privacy-policy" className="hover:text-background transition">
                Privacy Policy
              </Link>
              <Link href="/terms-of-service" className="hover:text-background transition">
                Terms of Service
              </Link>
              <Link href="/impact-report" className="hover:text-background transition">
                Impact Report
              </Link>
            </div>
          </div>
